...
def generate_rsa_key(bits=_DEFAULT_RSA_KEY_BITS):
  ...
  <Purpose> 
    ...
    returned conforms to 'tuf.ssl_crypto.formats.RSAKEY_SCHEMA' and has the
    form:
    ...
    >>> tuf.ssl_crypto.formats.RSAKEY_SCHEMA.matches(rsa_key)
    True
    >>> public = rsa_key['keyval']['public']
    >>> private = rsa_key['keyval']['private']
    >>> tuf.ssl_crypto.formats.PEMRSA_SCHEMA.matches(public)
    True
    >>> tuf.ssl_crypto.formats.PEMRSA_SCHEMA.matches(private)
    True
  ...
  <Returns>
    ...
    Conforms to 'tuf.ssl_crypto.formats.RSAKEY_SCHEMA'. 
  """

  # Does 'bits' have the correct format?
  # This check will ensure 'bits' conforms to 'tuf.ssl_crypto.formats.RSAKEYBITS_SCHEMA'.
  ...
  # tuf.ssl_crypto.formats.RSAKEYBITS_SCHEMA.check_match().
  if _RSA_CRYPTO_LIBRARY == 'pycrypto':
    public, private = tuf.ssl_crypto.pycrypto_keys.generate_rsa_public_and_private(bits)
...
def generate_ed25519_key():
  ...
  <Purpose> 
    ...
    The object returned conforms to 'tuf.ssl_crypto.formats.ED25519KEY_SCHEMA' and has the
    form:
    {'keytype': 'ed25519',
    ...
    >>> tuf.ssl_crypto.formats.ED25519KEY_SCHEMA.matches(ed25519_key)
    True
  ...
  <Returns>
    ...
    Conforms to 'tuf.ssl_crypto.formats.ED25519KEY_SCHEMA'. 
  """
...
def format_keyval_to_metadata(keytype, key_value, private=False):
  """
  <Purpose>
    Return a dictionary conformant to 'tuf.ssl_crypto.formats.KEY_SCHEMA'.
    ...
    >>> tuf.ssl_crypto.formats.KEY_SCHEMA.matches(ed25519_metadata)
    True
  ...
  <Arguments>
    ...
    key_value:
      ...
      conformant to 'tuf.ssl_crypto.formats.KEYVAL_SCHEMA'.
  ...
  <Exceptions>
    ...
    'tuf.ssl_crypto.formats.KEYVAL_SCHEMA', or if the private key is not present in
  ...
  <Returns>
    A 'tuf.ssl_crypto.formats.KEY_SCHEMA' dictionary.
  """
  ...
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.KEYTYPE_SCHEMA.check_match(keytype)
  
  # Does 'key_value' have the correct format?
  tuf.ssl_crypto.formats.KEYVAL_SCHEMA.check_match(key_value)
...
def format_metadata_to_key(key_metadata):
  """
  <Purpose>
    Construct a TUF key dictionary (e.g., tuf.ssl_crypto.formats.RSAKEY_SCHEMA)
    ...
    >>> tuf.ssl_crypto.formats.ED25519KEY_SCHEMA.matches(ed25519_key_2)
    True
  ...
  <Arguments>
    key_metadata:
      ...
      'tuf.ssl_crypto.formats.KEY_SCHEMA'.  It has the form:
  ...
  <Exceptions>
    ...
    'tuf.ssl_crypto.formats.KEY_SCHEMA'.
  ...
  <Returns>
    ...
    dictionary conformant to 'tuf.ssl_crypto.formats.RSAKEY_SCHEMA'.
  """
  ...
  # of objects and object types, and that all dict keys are properly named.
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.KEY_SCHEMA.check_match(key_metadata)
  ...
  # Convert 'key_value' to 'tuf.ssl_crypto.formats.KEY_SCHEMA' and generate its hash
...
def create_signature(key_dict, data):
  ...
  <Purpose>
    ...
    >>> tuf.ssl_crypto.formats.SIGNATURE_SCHEMA.matches(signature)
    True
    >>> len(signature['sig'])
    128
  ...
  if keytype == 'rsa':
    if _RSA_CRYPTO_LIBRARY == 'pycrypto':
      sig, method = tuf.ssl_crypto.pycrypto_keys.create_rsa_signature(private, data.encode('utf-8'))
  ...
  # 'tuf.ssl_crypto.formats.ANYKEY_SCHEMA' should detect invalid key types. 
  else: # pragma: no cover
...
def verify_signature(key_dict, signature, data):
  ...
  <Arguments>
    ...
    signature:
      ...
      Conformant to 'tuf.ssl_crypto.formats.SIGNATURE_SCHEMA'.
  ...
  if keytype == 'rsa':
    if _RSA_CRYPTO_LIBRARY == 'pycrypto':
      if 'pycrypto' not in _available_crypto_libraries: # pragma: no cover
        ...
        valid_signature = tuf.ssl_crypto.pycrypto_keys.verify_rsa_signature(sig, method,
                                                                 public, data) 
    elif _RSA_CRYPTO_LIBRARY == 'pyca-cryptography': 
...
def import_rsakey_from_encrypted_pem(encrypted_pem, password):
  ...
  <Purpose> 
    ...
    >>> tuf.ssl_crypto.formats.RSAKEY_SCHEMA.matches(rsa_key)
    True
    >>> tuf.ssl_crypto.formats.RSAKEY_SCHEMA.matches(rsa_key2)
    True
  ...
  # 'tuf.ssl_crypto.formats.PEMRSA_SCHEMA'.
  tuf.ssl_crypto.formats.PEMRSA_SCHEMA.check_match(encrypted_pem)
  ...
  if _RSA_CRYPTO_LIBRARY == 'pycrypto':
    public, private = \
      tuf.ssl_crypto.pycrypto_keys.create_rsa_public_and_private_from_encrypted_pem(encrypted_pem,
                                                                         password)
...
def format_rsakey_from_pem(pem):
  ...
  <Purpose> 
    ...
    'tuf.ssl_crypto.formats.RSAKEY_SCHEMA' and has the form:
  ...
  # of objects and object types, and that all dict keys are properly named.
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.PEMRSA_SCHEMA.check_match(pem)
...
def encrypt_key(key_object, password):
  ...
  <Purpose>
    ...
    >>> tuf.ssl_crypto.formats.ENCRYPTEDKEY_SCHEMA.matches(encrypted_key)
    True
  ...
  <Side Effects>
    ...
    'tuf.tufformats.GENERAL_CRYPTO_LIBRARY' and 'password'.

  <Returns>
    An encrypted string of the form: 'tuf.ssl_crypto.formats.ENCRYPTEDKEY_SCHEMA'.
  """
  ...
  # of objects and object types, and that all dict keys are properly named.
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.ANYKEY_SCHEMA.check_match(key_object)
  ...
  if _GENERAL_CRYPTO_LIBRARY == 'pycrypto':
    encrypted_key = \
      tuf.ssl_crypto.pycrypto_keys.encrypt_key(key_object, password)
...
def decrypt_key(encrypted_key, passphrase):
  ...
  <Purpose>
    ...
    >>> tuf.ssl_crypto.formats.ANYKEY_SCHEMA.matches(decrypted_key)
    True
  ...
  <Arguments>
    encrypted_key:
      ...
      of the form 'tuf.ssl_crypto.formats.ENCRYPTEDKEY_SCHEMA'.  'encrypted_key' should
  ...
  <Returns>
    A TUF key object of the form: 'tuf.ssl_crypto.formats.ANYKEY_SCHEMA' (e.g.,
  ...
  # of objects and object types, and that all dict keys are properly named.
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.ENCRYPTEDKEY_SCHEMA.check_match(encrypted_key)
  ...
  if _GENERAL_CRYPTO_LIBRARY == 'pycrypto':
    key_object = \
      tuf.ssl_crypto.pycrypto_keys.decrypt_key(encrypted_key, passphrase)
...
def create_rsa_encrypted_pem(private_key, passphrase):
  ...
  >>> passphrase = 'secret'
  >>> encrypted_pem = create_rsa_encrypted_pem(private, passphrase)
  >>> tuf.ssl_crypto.formats.PEMRSA_SCHEMA.matches(encrypted_pem)
  True
  ...
  Conforms to 'tuf.ssl_crypto.formats.PEMRSA_SCHEMA'.
  """
  ...
  # of objects and object types, and that all dict keys are properly named.
  # Raise 'tuf.ssl_commons.exceptions.FormatError' if the check fails.
  tuf.ssl_crypto.formats.PEMRSA_SCHEMA.check_match(private_key)
  ...
  if _RSA_CRYPTO_LIBRARY == 'pycrypto':
    encrypted_pem = \
      tuf.ssl_crypto.pycrypto_keys.create_rsa_encrypted_pem(private_key, passphrase)
