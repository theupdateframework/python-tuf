...
FILEINFODICT_SCHEMA = SCHEMA.DictOf(
  ...
  value_schema = SCHEMA.OneOf([tuf.ssl_crypto.formats.VERSIONINFO_SCHEMA, tuf.ssl_crypto.formats.FILEINFO_SCHEMA]))

# A list of path hash prefixes.
#PATH_HASH_PREFIXES_SCHEMA = SCHEMA.ListOf(tuf.ssl_crypto.formats.PATH_HASH_PREFIX_SCHEMA)
...
def check_signable_object_format(object):
  ...
  <Purpose>
    ...
    'tuf.ssl_crypto.formats.SIGNABLE_SCHEMA'.  Return the signing role on success.
