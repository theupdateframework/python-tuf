...
def create_signature(public_key, private_key, data, use_pynacl=False):
  ...
  <Purpose>
    ...
    >>> signature, method = create_signature(public, private, data, use_pynacl=False)
    >>> len(signature)
    64
    >>> method == 'ed25519-python'
    True
    >>> signature, method = create_signature(public, private, data, use_pynacl=True)
    >>> len(signature)
    64
...
def verify_signature(public_key, method, signature, data, use_pynacl=False):
  ...
  <Purpose>
    ...
    >>> bad_signature, method = create_signature(public, private, bad_data, use_pynacl=False)
