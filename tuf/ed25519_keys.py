...
def generate_public_and_private():
  ...
  <Purpose> 
    ...
    'tuf.tufformats.ED25519SEED_SCHEMA', respectively, and have the form:
    ...
    >>> tuf.tufformats.ED25519PUBLIC_SCHEMA.matches(public)
    True
    >>> tuf.tufformats.ED25519SEED_SCHEMA.matches(private)
    True
  ...
  <Returns>
    A (public, private) tuple that conform to 'tuf.tufformats.ED25519PUBLIC_SCHEMA'
    and 'tuf.tufformats.ED25519SEED_SCHEMA', respectively.
  """
...
def create_signature(public_key, private_key, data):
  ...
  <Purpose>
    ...
    to 'tuf.tufformats.ED25519SIGNATURE_SCHEMA', and has the form:
  ...
  tuf.tufformats.ED25519SEED_SCHEMA.check_match(private_key)
...
def verify_signature(public_key, method, signature, data, use_pynacl=False):
  ...
  tuf.tufformats.NAME_SCHEMA.check_match(method)
  
  # Is 'signature' properly formatted?
  tuf.tufformats.ED25519SIGNATURE_SCHEMA.check_match(signature)
  
  # Is 'use_pynacl' properly formatted?
  tuf.tufformats.BOOLEAN_SCHEMA.check_match(use_pynacl)
