...
class Updater(object):
  ...
  def _verify_uncompressed_metadata_file(self, metadata_file_object,
      metadata_role):
    self.metadata_handler._verify_uncompressed_metadata_file(metadata_file_object,
                                                             metadata_role)
  ...
  def _get_metadata_file_content(self, metadata_role, remote_filename,
    ...
    return self.metadata_handler._get_metadata_file_content(
  ...
  def _verify_root_chain_link(self, rolename, current_root_metadata,
    next_root_metadata):
    self.metadata_handler._verify_root_chain_link(rolename, current_root_metadata, next_root_metadata)
  ...
  def _move_current_to_previous(self, metadata_role):
    self.metadata_handler.move_current_to_previous(metadata_role)
  ...
  def _ensure_not_expired(self, metadata_object, metadata_rolename):
    self.metadata_handler._ensure_not_expired(metadata_object, metadata_rolename)
