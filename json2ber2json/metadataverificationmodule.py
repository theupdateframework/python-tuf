...
# (last modified on 2016-12-22 14:40:06.482974)
...
Custom.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('releaseCounter', Positive().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.OptionalNamedType('ecuHardwareType', char.VisibleString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 32)).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
