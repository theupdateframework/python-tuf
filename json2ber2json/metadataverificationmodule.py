...
# (last modified on 2016-12-18 22:36:22.085890)
...
Target.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('versionNumber', char.VisibleString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 32)).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
...
Custom.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('ecuIdentifier', Identifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
