...
# (last modified on 2016-12-26 16:35:40.593633)
...
Custom.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('hardwareIdentifier', Natural().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
