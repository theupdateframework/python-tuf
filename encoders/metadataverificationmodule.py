...
# (last modified on 2016-10-08 15:11:45.624188)
...
SnapshotMetadata.subtypeSpec=constraint.ValueSizeConstraint(1, 128)
...
TopLevelRole.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('url', URLs().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
    namedtype.NamedType('keyids', Keyids().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))),
    namedtype.NamedType('threshold', Threshold().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)))
)
...
Repository.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('mirrors', URLs().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
