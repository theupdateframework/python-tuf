...
# (last modified on 2016-10-08 20:36:32.663220)
...
SnapshotMetadata.componentType = namedtype.NamedTypes(
    namedtype.NamedType('numberOfFiles', Length().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.NamedType('files', FilenameAndVersions().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))
)
