...
# (last modified on 2016-10-05 21:17:47.869406)
...
class TargetsDelegation(univ.Sequence):
    pass


TargetsDelegation.componentType = namedtype.NamedTypes(
    namedtype.NamedType('keys', PublicKeys().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
...
class TargetsDelegations(univ.SequenceOf):
    pass


TargetsDelegations.componentType = TargetsDelegation()
...
TargetsMetadata.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('delegations', TargetsDelegations().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))
)
