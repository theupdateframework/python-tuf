...
# (last modified on 2016-10-04 16:20:55.839014)
...
class DelegatedTargetsRoles(univ.Sequence):
    pass


DelegatedTargetsRoles.componentType = namedtype.NamedTypes(
...
class TopLevelRoles(univ.Sequence):
    pass


TopLevelRoles.componentType = namedtype.NamedTypes(
...
RootMetadata.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('roles', TopLevelRoles().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)))
)
...
TargetsDelegations.componentType = namedtype.NamedTypes(
    namedtype.NamedType('keys', PublicKeys().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.NamedType('roles', DelegatedTargetsRoles().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))),
    namedtype.NamedType('pathsToRoles', PathsToRoles().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2)))
)


class Targets(univ.Sequence):
    pass


Targets.componentType = namedtype.NamedTypes(
...
TargetsMetadata.componentType = namedtype.NamedTypes(
    namedtype.NamedType('targets', Targets().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))),
